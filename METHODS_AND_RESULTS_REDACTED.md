...
#### Herb 7 — Literature Sources for Active Compounds
...
For TCMSP-sourced herbs (12 herbs), the strict OB ≥ 30% and DL ≥ 0.18 filter was applied. For supplementary herbs (Herb 7, Herb 13), a relaxed filter of OB ≥ 30% was used because many of their key bioactive compounds (e.g., a characteristic small-molecule compound with DL=0.06) are small molecules with well-documented pharmacological activity but low DL values.
...
For Herb 7 and Herb 13, targets were obtained by:
...
**Result:** 541 supplementary target entries added for Herb 7 and Herb 13.
